      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a202c; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
          ...
          <div style="padding: 30px;">
            ...
            <p>Hi there,</p>
            <p>Thank you for requesting an AI solar evaluation for <strong>${address}</strong>.</p>
            ...
            <div style="background-color: #fffbeb; padding: 24px; border-radius: 8px; margin: 24px 0; border: 1px solid #fde68a;">
              ...
              <p style="margin-bottom: 0; color: #b45309; line-height: 1.6;">
                Based on your roof's capacity, your home is a prime candidate for a <strong>$0-Down Power Purchase Agreement (PPA)</strong>. 
                <br><br>
            ...
            <p>A Senior Solar Advisor will be calling you shortly from a local area code to review your current utility bill and finalize your $0-down qualification.</p>
