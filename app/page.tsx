...
function HomeView({ setView }: { setView: (view: 'home' | 'admin') => void }) {
  ...
  return (
    ...
    <footer className="w-full text-center py-8 border-t border-line text-xs text-muted mt-12 bg-paper"><p className="mb-2 font-bold">&copy; 2026 MAGNETAR (operating as SentiSolar)</p><a href="/privacy" className="hover:underline mr-4">Privacy Policy</a><a href="/terms" className="hover:underline">Terms &amp; Conditions</a></footer>
</main>
  )
}
